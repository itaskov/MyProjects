...
namespace TennisNetwork.Controllers
{
    ...
    public class ManageController : BaseController
    {
        ...
        public ActionResult ChangeAddress()
        {
            ...
            var address = this.Data.Addresses.All().Where(a => a.ApplicationUserId == userId).Select(ChangeAddressViewModel.FromAddress).FirstOrDefault();
        ...
        {
            var userId = User.Identity.GetUserId();
            var user = this.Data.Users.All().Where(u => u.Id == userId).Select(ChangeUserDataViewModel.FromUser).FirstOrDefault();

            ViewBag.UserLevelId = new SelectList(this.Data.UserLevels.All().ToList(), "Id", "Level", user.UserLevelId);
